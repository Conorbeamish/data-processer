...
const Datapoints = () => {
  ...
  return (
    ...
    <p><em>One example might be measuring the effects of a new mood elevator where Group A has taken the drug and Group B is the control with them rating their mood before and after out of 10</em></p>
